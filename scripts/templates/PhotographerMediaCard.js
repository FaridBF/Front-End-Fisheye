...
export default class PhotographerMediaCard {
  ...
  addMediaVideo(media) {
    ...
    <div class="container_title_like">
        ...
        <span class="like modal-trigger" aria-label="like ce contenu">${media.likes}<i class="fa-solid fa-heart"></i></span>
    </div> 
    `;
  ...
  addMediaImage(media) {
    ...
    <div class="container_title_like">
      ...
      <div>
        <span tabindex="9" aria-label="like ce contenu" class="like">${media.likes}<i class="fa-solid fa-heart"></i></span>
      </div>
    </div>
    `;
